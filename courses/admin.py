...
from courses.models import Course, Learning, Prerequisite, Tag, Video, UserCourse, Payment
from django.utils.html import format_html

from courses.models import CouponCode
...
class PaymentAdmin(admin.ModelAdmin):
    model = Payment
    list_display = ['payment_id', "get_user", "get_course", "status", "date"]
...
class CouponCodeAdmin(admin.ModelAdmin):
    model = CouponCode
    list_display = ['code', "course", "discount"]
    list_filter = ["code", "course"]
